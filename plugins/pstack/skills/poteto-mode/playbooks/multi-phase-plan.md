...
6. Run `node ~/.omp/pstack/skills/poteto-mode/scripts/check-plan.mjs <plan.md>`, which is `scripts/check-plan.mjs` under the skill root, and fix every line it prints (the **encode-lessons-in-structure** principle skill).
